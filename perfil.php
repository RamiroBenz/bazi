          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
				...
				<div id="load_img">
					<img class="img-responsive" src="<?php echo $row['logo_url'];?>" alt="Logo" style="border-radius: 10px;">
				...
				<!-- <div class='col-md-12' id="resultados_ajax"></div> --><!-- Carga los datos ajax -->
                 ...
                 <div class="panel-footer text-center">
                            ...
                            <button style="background-color: #6666ff" type="submit" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-refresh"></i> Actualizar datos</button>
