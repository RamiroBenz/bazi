...
<body>
 <div class="container">
  ...
  <h1 style="color: blue; font-weight: 900;"><?php echo $nombre; ?></h1>
  <h2 style="color: black;font-size: 16px"><?php echo $h2; ?></h2>
        ...
        <div class="card card-container">
			...
			<?php
                ...
                <button style="background-color: #6666ff" type="submit" class="btn btn-lg btn-success btn-block btn-signin" name="login" id="submit">Iniciar Sesión</button>
            </form><!-- /form -->
